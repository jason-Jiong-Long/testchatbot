...
def runs():
    ...
    parser.add_argument("--model_checkpoint", type=str, default="./run/run", help="Path, url or short name of the model")
...
def runfirst(text, tokenizer, model, args):
    history = []
    def tokenize(obj):
...
if __name__ == "__main__":
    tokenizer, model, args=runs()
    while True:
        text=input(">>")
        out_text=runfirst(text, tokenizer, model, args)
        print(out_text)
